...
const testimonials = [
  {
    ...
    quote: 'The entire buying process was transparent and stress-free. The team kept us updated at every stage of construction. We moved into our 3-bedroom unit on the exact promised date!',
  ...
  },
  {
    ...
    quote: 'As a landowner, I was nervous about joint ventures. But their professional approach, clear agreements, and timely delivery won my complete trust. I received my units as promised.',
  ...
  },
  {
    ...
    quote: 'Quality of construction is exceptional. Two years after moving in and everything is still perfect. Their after-sales service team is always responsive.',
  ...
  },
  {
    ...
    quote: 'I did thorough research before buying. This company\'s RAJUK compliance and transparent pricing gave me full confidence. The apartment exceeded my expectations.',
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative">
          ...
          <div>
            ...
            <div className="text-amber-300 text-xs mt-1 font-medium">{t.project}</div>
          </div>
        </div>
