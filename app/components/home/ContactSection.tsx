...
const tabs: { id: LeadType; label: string; desc: string }[] = [
  {
    id: "buyer",
    label: "🏠 Buyer Inquiry",
    desc: "Interested in buying a unit",
  },
  {
    id: "landowner",
    label: "🌿 Landowner JV",
    desc: "Want to discuss a joint venture",
  },
...
export default function ContactSection() {
  ...
  const inputCls =
    "w-full px-4 py-3 rounded-lg border border-stone-200 bg-stone-50 focus:bg-white focus:border-amber-400 focus:ring-2 focus:ring-amber-100 outline-none text-stone-800 text-sm transition-all placeholder:text-stone-400";
            ...
            <div className="space-y-5">
              {[
                ...
                },
                {
                  icon: Mail,
                  label: "Email Us",
                  value: "info@realestate-bd.com",
                  href: "mailto:info@realestate-bd.com",
                },
                {
                  icon: MapPin,
                  label: "Head Office",
                  value: "House 12, Road 5, Gulshan 2, Dhaka 1212",
                  href: "#",
                },
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              set("projectInterest", e.target.value)
                            }
                          />
                        </div>
                        <div>
