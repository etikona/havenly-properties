      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-stone-400 max-w-xl mx-auto text-base">
            Whether you're looking to buy your dream home or develop your land —
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="group relative rounded-2xl overflow-hidden">
            ...
            <div className="relative z-10 p-8 min-h-[280px] flex flex-col justify-end">
              ...
              <h3 className="text-xl font-bold text-white mb-2">For Home Buyers</h3>
              <p className="text-stone-300 text-sm mb-5 leading-relaxed">
                Explore payment plans, bank loan options, and required documents.
                Our team guides you through every step of the purchase process.
              </p>
              <Link
                href="/buyers"
              ...
              >
                Buyer's Guide <ArrowRight className="w-4 h-4" />
              </Link>
            </div>
          </div>
          ...
          <div className="group relative rounded-2xl overflow-hidden">
            ...
            <div className="relative z-10 p-8 min-h-[280px] flex flex-col justify-end">
              ...
              <h3 className="text-xl font-bold text-white mb-2">For Landowners</h3>
              <p className="text-stone-300 text-sm mb-5 leading-relaxed">
                Partner with us through our Joint Venture program. Get up to 40% of
                developed units with zero upfront investment.
              </p>
              <Link
                href="/landowners"
                className="inline-flex items-center gap-2 text-amber-400 font-semibold text-sm hover:text-amber-300 transition-colors group-hover:gap-3"
